...
WebUI.setText(findTestObject('PIM/01. Add/01. EditEmployee/02. Job/txt_JoinDate'), '123456789')

WebUI.click(findTestObject('PIM/01. Add/01. EditEmployee/02. Job/null'))

WebUI.verifyElementPresent(findTestObject('PIM/01. Add/01. EditEmployee/02. Job/txt_JoinDateError'), 0)
