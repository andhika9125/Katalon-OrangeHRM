...
WebUI.uploadFile(findTestObject('PIM/01. Add/01. EditEmployee/02. Job/btn_UploadContract'), 'C:\\Users\\Dika\\Desktop\\1.png')

WebUI.click(findTestObject('PIM/01. Add/01. EditEmployee/03. Personal Info/btn_Edit-Save'))

WebUI.verifyTextPresent('Failed to Save: File Size Exceeded', false)
